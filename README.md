# Cloudflare's challange-1 implementation
...
## The solution
Cloudflare Workers offers the datacenter nearest airport code in the request, mapping the code to the airport name, we get the AirportName’s Music Festival. And eberyone knows that all good festivals are host in airports.
Page link https://cf-challange-1.cl4.workers.dev/.
